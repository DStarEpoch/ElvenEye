...
class Animation:
	...
	def __init__(self,mapfile = 'test.mpd'):
		...
		#self.path = psA.Path_Lib(dimention = 2, startpoint = (56,175), endpoint = (172, 33), milestone_label = 1) 
		self.path = psA.Path_Lib(dimention = 2, startpoint = (56, 175), endpoint = (172, 33))
